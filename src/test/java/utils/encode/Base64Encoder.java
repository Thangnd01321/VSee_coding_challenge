 ...
 *
 * <p>Despite there being a gazillion other Base64 implementations out there, this has been written
 * as part of XStream as it forms a core part but is too trivial to warrant an extra dependency.
 *
 * <p>This meets the standard as described in RFC 1521, section 5.2
...
public class Base64Encoder {
  ...
  public String encode(byte[] input) {
    ...
    for (int i = 0; i < input.length; i += 3) {
      ...
      for (int j = 0; j < 4; j++)
        result.append(
            remaining + 1 > j ? SIXTY_FOUR_CHARS[0x3f & oneBigNumber >> 6 * (3 - j)] : '=');
